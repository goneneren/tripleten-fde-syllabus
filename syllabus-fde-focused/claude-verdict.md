...
> **Historical review:** This records the pre-adoption assessment of the focused curriculum. The former five-project syllabus, LocalStack variant, and Project 5 rubric cited below were removed from the working tree; their paths are retained as plain-text historical citations, not links. The Open-Source six-project curriculum is now the program of record.
...
- **Recommended correction:** Publish a fixed cloud deployment profile as a table in the Project 6 header, matching the prohibition list in the former `syllabus/project-5-aws-deployment.md:33`.
...
- **Severity:** Critical
- **File/line:** [opensource.md:360](syllabus-fde-focused/fde-focused-6-projects-opensource.md:360) ("AWS budget dashboard"), [:370](syllabus-fde-focused/fde-focused-6-projects-opensource.md:370) ("Supplied CloudFormation or OpenTofu templates"), [:372](syllabus-fde-focused/fde-focused-6-projects-opensource.md:372) ("trusted TLS"); identical at [localstack.md:369](syllabus-fde-focused/fde-focused-6-projects-localstack.md:369), [:379](syllabus-fde-focused/fde-focused-6-projects-localstack.md:379), [:381](syllabus-fde-focused/fde-focused-6-projects-localstack.md:381). Compare the former `syllabus/project-5-aws-deployment.md:39-52`.
...
- **Recommended correction:** Delete the GPU and PEFT/LoRA thread entirely from both variants and replace the former `projects/project-5-rubric.md`. The evidence is decisive: the role brief records that fine-tuning appears in **zero of 41 postings** and states plainly that it "is a different profession" (`reference/Forward Deployed Engineer — the role, explained_files/saved_resource.html`, "The job does not" / "Weak fit ML engineer" sections). There is no market cost to removal and a large operational saving.
...
- **File/line:** [localstack.md:25](syllabus-fde-focused/fde-focused-6-projects-localstack.md:25), [:26](syllabus-fde-focused/fde-focused-6-projects-localstack.md:26), [:7](syllabus-fde-focused/fde-focused-6-projects-localstack.md:7). Compare the former `syllabus-localstack-gemini/README.md:29-31` and `syllabus-localstack-gemini/overview-and-module-map.md:66-83`.
- **Project/task:** Program-wide
...
- **Severity:** Critical (LocalStack variant)
- **File/line:** [localstack.md:60](syllabus-fde-focused/fde-focused-6-projects-localstack.md:60), [:87](syllabus-fde-focused/fde-focused-6-projects-localstack.md:87), [:88-90](syllabus-fde-focused/fde-focused-6-projects-localstack.md:88). Compare the former `syllabus-localstack-gemini/overview-and-module-map.md:49`.
...
- **Severity:** Critical (LocalStack variant)
- **File/line:** [localstack.md:77](syllabus-fde-focused/fde-focused-6-projects-localstack.md:77), [:137](syllabus-fde-focused/fde-focused-6-projects-localstack.md:137), [:147](syllabus-fde-focused/fde-focused-6-projects-localstack.md:147), [:27](syllabus-fde-focused/fde-focused-6-projects-localstack.md:27), [:7](syllabus-fde-focused/fde-focused-6-projects-localstack.md:7). Compare the former `syllabus-localstack-gemini/overview-and-module-map.md:55-62`.
...
- **Exact issue at the time of review:** [AGENTS.md](AGENTS.md) was the repository's authority and stated 5 projects, ~452 hours, Project 5 as the AWS capstone, `syllabus/` as canonical, and `syllabus-localstack-gemini/` as unadopted. `syllabus-fde-focused/` appeared nowhere in the sitemap. More materially, the then-current `executive-overview.md` made the whole build economically viable by **reusing the same 5 SE starter repositories** across the SE and FDE tracks. The current `AGENTS.md` and `executive-overview.md` resolve this governance issue by naming the Open-Source six-project curriculum as the program of record and Project 6 as deployment of the accepted Project 5 release.
...
- **Resolution:** The Open-Source document now identifies itself as the program of record; the LocalStack edition identifies itself as an alternative under evaluation. `AGENTS.md` and `executive-overview.md` now use the same boundary.
...
- **Consequence:** Either an unpriced overrun or a student paying with a personal card — which the former `syllabus/project-5-aws-deployment.md:15` explicitly forbids for AWS and should equally forbid here.
...
| M3 | [opensource.md:352](syllabus-fde-focused/fde-focused-6-projects-opensource.md:352) | "normal delivery should target materially below the ceiling" is unquantified, where the former `syllabus/project-5-aws-deployment.md:31` gives a specific $80 target. | State the number: "normal target $70; $40 remediation reserve; $70 contingency; $180 hard cap." |
...
This aligns with the former repository's $80 normal target in `syllabus/project-5-aws-deployment.md:31` and is comfortable — *provided* the capstone fits one t3.large. Under the six-project scope it may not: the P5 capstone carries a keyword search tier, an identity service, and a tracing UI on top of the application, database and worker. Hence C4's requirement to publish a fixed profile that drops Phoenix, Prometheus, Grafana and Keycloak from the cloud deployment.
...
Any two of these together exhaust the cap. All of them were controlled in the former `syllabus/project-5-aws-deployment.md:41-43` and none are controlled in the new documents, whose sole cost mechanism is "AWS budget dashboard" ([opensource.md:360](syllabus-fde-focused/fde-focused-6-projects-opensource.md:360)).
...
8. **Add acceptance evidence to all 31 tasks** — apply the C1 pattern task by task. Author a six-project rubric set on the model of the former `projects/project-5-rubric.md`. Add the I-19 evidence boundary to the Project 4 header and the M8 decision rules to Tasks 4.5, 6.3 and 6.5.
...
4. **The Project 6 cloud profile and control plane.** Which services deploy, on what instance, with the constrained role, Budget Action, DNS zone and automated teardown described in the former `syllabus/project-5-aws-deployment.md` restated. Until this exists, "$180 maximum" is a hope. With it, the realistic bill is ~$70 and the cap has genuine headroom.
